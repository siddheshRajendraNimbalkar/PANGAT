...
export default function page({ children }: { children: React.ReactNode }) {
  return (
    <>
      <div className="h-screen w-screen bg-indigo-500 flex flex-col">
      <div className="fixed top-2 left-2 flex items-center pd-4 bg-indigo-500 rounded-lg">
        <Image
        ...
        />
        <h1 className="text-lg pl-2 text-white  font-bold">PANGAT</h1>
      </div>
      <div className="h-full w-full   bg-indigo-500 flex">
        <div className="hidden bg-[url('/luis-villasmil-ITFwHdPEED0-unsplash.jpg')] bg-cover bg-center h-full w-3/5 p-4 md:flex flex-col justify-center">
          ...
          <h4 className="font-medium text-white md:text-base lg:text-2xl">
            PANGAT is great for playing games and chilling with friends, <br />
